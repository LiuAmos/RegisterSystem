...
mysqli_query($db_link,"INSERT INTO student (account,password,name,phone,email,birthday,skype,graduation) 
VALUES ('$reg_account','$reg_password','$reg_name','$reg_phone','$reg_email','$reg_birthday','$reg_skype','$reg_graduation')");
...
//操作資料庫
mysqli_select_db($db_link,"registersystem");
$result= mysqli_query($db_link, "select account,password from 'student'");
